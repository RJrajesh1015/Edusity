...
const About = () => {
  return (
    <div className='about'>
        ...
        <p>Embark on a transformative educational journey with our university's comperhensive education programs. our cutting-edge curriculam is designed to empower students with the knowledge, skills, and experiences needed to excel in the dynamic field of education.</p>
